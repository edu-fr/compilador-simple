...
0000000000400358 <.note.gnu.build-id>:
  ...
  400367:	00 81 ab ef 52 e7    	add    %al,-0x18ad1055(%rcx)
  40036d:	89 e6                	mov    %esp,%esi
  40036f:	19 ac 19 99 5c 9d 61 	sbb    %ebp,0x619d5c99(%rcx,%rbx,1)
  400376:	28 23                	sub    %ah,(%rbx)
  400378:	41                   	rex.B
  400379:	b9                   	.byte 0xb9
  40037a:	64                   	fs
  40037b:	a9                   	.byte 0xa9
...
0000000000401130 <funcao>:
  ...
  401134:	89 7c 24 10          	mov    %edi,0x10(%rsp)
  401138:	89 74 24 14          	mov    %esi,0x14(%rsp)
  40113c:	89 7c 24 0c          	mov    %edi,0xc(%rsp)
  401140:	e8 3b 00 00 00       	call   401180 <imprimei>
  401145:	c7 44 24 0c 0a 00 00 	movl   $0xa,0xc(%rsp)
  40114c:	00 
  40114d:	bf 0a 00 00 00       	mov    $0xa,%edi
  401152:	e8 29 00 00 00       	call   401180 <imprimei>
  401157:	48 83 c4 18          	add    $0x18,%rsp
  40115b:	c3                   	ret    
  40115c:	0f 1f 40 00          	nopl   0x0(%rax)

0000000000401160 <main>:
  401160:	50                   	push   %rax
  401161:	bf 14 00 00 00       	mov    $0x14,%edi
  401166:	e8 15 00 00 00       	call   401180 <imprimei>
  40116b:	bf 03 00 00 00       	mov    $0x3,%edi
  401170:	be 04 00 00 00       	mov    $0x4,%esi
  401175:	e8 b6 ff ff ff       	call   401130 <funcao>
  40117a:	59                   	pop    %rcx
  40117b:	c3                   	ret    
  40117c:	0f 1f 40 00          	nopl   0x0(%rax)

0000000000401180 <imprimei>:
  401180:	55                   	push   %rbp
  401181:	48 89 e5             	mov    %rsp,%rbp
  401184:	48 83 ec 10          	sub    $0x10,%rsp
  401188:	48 89 7d f8          	mov    %rdi,-0x8(%rbp)
  40118c:	48 8b 75 f8          	mov    -0x8(%rbp),%rsi
  401190:	48 bf 04 20 40 00 00 	movabs $0x402004,%rdi
  401197:	00 00 00 
  40119a:	b0 00                	mov    $0x0,%al
  40119c:	e8 8f fe ff ff       	call   401030 <printf@plt>
...
000000000040200c <__GNU_EH_FRAME_HDR>:
  ...
  402032:	ff                   	(bad)  
  402033:	ff a4 00 00 00 54 f1 	jmp    *-0xeac0000(%rax,%rax,1)
  40203a:	ff                   	(bad)  
  40203b:	ff                   	(bad)  
  40203c:	bc 00 00 00 74       	mov    $0x74000000,%esp
  402041:	f1                   	icebp  
  402042:	ff                   	(bad)  
...
0000000000402048 <__FRAME_END__-0xb8>:
  ...
  4020ba:	ff                   	(bad)  
  4020bb:	ff 2c 00             	ljmp   *(%rax,%rax,1)
  4020be:	00 00                	add    %al,(%rax)
  4020c0:	00 44 0e 20          	add    %al,0x20(%rsi,%rcx,1)
  4020c4:	67 0e                	addr32 (bad) 
  ...
  4020e7:	00 98 f0 ff ff 27    	add    %bl,0x27fffff0(%rax)
...
0000000000403e20 <_DYNAMIC>:
  ...
  403e47:	00 a8 11 40 00 00    	add    %ch,0x4011(%rax)
